    ...
    // Slide 1: Welcome slide with logos
    {
        ...
        `
            ...
            <p>
                ...
                <a href="https://getsnooz.com" target="_blank">
            ...
            <p>
                <strong>AND Sponsored by:</strong>
    ...
    // Slide 4: Rules and submission guidelines
    {
        ...
        content: `
            <ul>
                ...
                <li><strong>Team Size:</strong> Teams are allowed. If you work in a team, you will split the prizes. Only one submission per team is allowed.</li>
                ...
                <li><strong>Originality:</strong> Your project must be created during the hackathon timeframe. No pre-existing projects.</li>
            </ul>
        `,
    ...
    // Slide 6: Deliverables and deployment requirements
    {
        ...
        content: `
            ...
            <ul>
                ...
                <li>GIT or similar link to project</li>
            </ul>
            <p>Make sure your project is deployable locally or online!</p>
        `,
    ...
    // Slide 9: Submission instructions
    {
        ...
        content: `
            ...
            <ul>
                ...
                <li>A link to your project (GitHub)</li>
                <li>A brief project description</li>
            </ul>
            <p><em>Be sure to submit on time!</em></p>
        `,
